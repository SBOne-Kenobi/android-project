...
import com.rustamsadykov.firstapp.databinding.ViewVerificationCodeEditTextBinding
...
class VerificationCodeEditText @JvmOverloads constructor(
    ...
    init {
        ...
        context
            ...
            .apply {
                numberOfSlots = getInteger(R.styleable.VerificationCodeEditText_vcet_numberOfSlots, 6)
            }
    }
